...
However, note that these matrices only show the first 50 feartures. A sorting of pairs of words based on their correlation coefficients shows that there are some correlated features. Some exmaples are:
