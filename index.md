...
Let <img src="https://latex.codecogs.com/gif.latex?Z_i" title="Z_i" /> be the predicted labels for the ith article and <img src="https://latex.codecogs.com/gif.latex?Y_i" title="Y_i" /> be the ground truth labels for the ith article.
